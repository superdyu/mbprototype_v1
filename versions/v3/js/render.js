    ...
    <div class="admin-card">
      ...
      <div class="input-group">
        ...
        <select onchange="navAdminJump(this.value)">
          ${["streak","onboarding","login","dailyUpdate","dailySummary","dailyShare","home","journalEntry","journalConfirm","journalDone","aboutMe","budgetCategory","spendEstimator","profilePicker","lifestyleWizard","lifestyleWizardReview","budgetDone","myProgress","comparison",
...
function render() {
  ...
  screenRoot.classList.toggle("journal-mode",     ["journalEntry","journalConfirm","journalDone","profilePicker","lifestyleWizard","lifestyleWizardReview","budgetDone","spendEstimator"].includes(state.screen));
