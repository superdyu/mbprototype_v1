      ...
      <div class="admin-card">
        ...
        <div class="input-group">
          ...
          <select onchange="setTaskTab(${index}, this.value)">
            ...
            <option value="budget"      ${task.tab === "budget"      ? "selected" : ""}>Budget</option>
...
function setTaskTab(index, tab) {
  ...
  if (tab === "learn") {
    ...
    const tabDestMap = { budget: "budget", goals: "goals", marketplace: "marketplace", settings: "settings", other: "home" };
